...
int main(int argc, char* argv[])
{
    ...
    GLuint blueTexture = loadTexture("assets/textures/blue.jpg");
    GLuint redTexture = loadTexture("assets/textures/red.jpg");
    GLuint yellowTexture = loadTexture("assets/textures/yellow.jpg");
    GLuint magentaTexture = loadTexture("assets/textures/magenta.jpg");
    GLuint orangeTexture = loadTexture("assets/textures/orange.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1i(textureLocation, 0);
        mat4 playScreen = translate(mat4(1.0f), vec3(0.0f, 0.0f, 14.7f)) * rotate(mat4(1.0f), radians(180.0f), vec3(0.0f, 0.0f, 1.0f)) * scale(mat4(1.0f), vec3(10.0f, 5.0f, 0.5f));
        ...
        if (game)
        {
            if (g)
            {
                glBindTexture(GL_TEXTURE_2D, greenTexture);
                glUniform1i(textureLocation, 0);
                green = translate(mat4(1.0f), vec3(0.0f, 0.5f, 13.0f - speed)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
            ...
            if (b)
            {
                glBindTexture(GL_TEXTURE_2D, blueTexture);
                glUniform1i(textureLocation, 0);
                blue = translate(mat4(1.0f), vec3(2.0f, 0.1f, 13.0f - speed)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
            ...
            if (r)
            {
                glBindTexture(GL_TEXTURE_2D, redTexture);
                glUniform1i(textureLocation, 0);
                red = translate(mat4(1.0f), vec3(-2.0f, -0.1f, 13.0f - speed)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
            ...
            if (y)
            {
                glBindTexture(GL_TEXTURE_2D, yellowTexture);
                glUniform1i(textureLocation, 0);
                yellow = translate(mat4(1.0f), vec3(-1.0f, -0.5f, 13.0f - speed)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
            ...
            if (m)
            {
                glBindTexture(GL_TEXTURE_2D, magentaTexture);
                glUniform1i(textureLocation, 0);
                magenta = translate(mat4(1.0f), vec3(2.0f, 1.5f, 13.0f - speed)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
            ...
            if (o)
            {
                glBindTexture(GL_TEXTURE_2D, orangeTexture);
                glUniform1i(textureLocation, 0);
                orange = translate(mat4(1.0f), vec3(-2.0f, 1.0f, 13.0f - speed)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
